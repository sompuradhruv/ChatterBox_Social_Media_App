...
import 'package:chatapp_firebase/pages/profile_feature/profile_page.dart';
...
import '../group_feature/SearchPage.dart';
import 'about.dart';
...
class Pro extends StatefulWidget {
  ...
  @override
  State<Pro> createState() => _HomePageState();
}

class _HomePageState extends State<Pro> {
  String userName = "";
  String email = "";
  ...
  Widget build(BuildContext context) {
    ...
    children: <Widget>[
      CircleAvatar(
        ...
        backgroundImage: NetworkImage("https://images.hdqwalls.com/download/captain-america-minimal-cartoon-art-4k-xv-2048x1152.jpg"),),
    const SizedBox(
    height: 15,
    ),
    Text(
